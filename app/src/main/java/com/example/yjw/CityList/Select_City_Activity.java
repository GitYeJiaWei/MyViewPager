...
import com.example.yjw.CityList.CityList.DbHelper.AllCitySqliteOpenHelper;
import com.example.yjw.CityList.CityList.DbHelper.CityUtils;
import com.example.yjw.CityList.CityList.Model.CitySortModel;
...
public class Select_City_Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_select__city_);
        initViews();
    }
    ...
    private void setAdapter() {
        ...
        adapter = new SortAdapter(Select_City_Activity.this, SourceDateList);
