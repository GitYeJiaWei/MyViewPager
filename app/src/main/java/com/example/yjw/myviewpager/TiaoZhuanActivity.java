...
public class TiaoZhuanActivity  extends BaseActivity implements View.OnClickListener  {
    //首先我们必须要知道要跳转的app的包名，每一个APP的包名都是独立的，纵使是马甲包和主包的包名也是不一样的。
    //我们将要跳转的包名填在以下位置。
    public static final String APP_PACKAGE_NAME = "com.ioter.bank";
    private Button bt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt = (Button) findViewById(R.id.btn_tiaozhuan);
        //为按钮设置监听
